...
export const enum ParametroEnum {
  TOLERANCIA_INICIO_DESDE = 'TOLERANCIA_INICIO_DESDE',
  TOLERANCIA_INICIO_HASTA = 'TOLERANCIA_INICIO_HASTA',
  TOLERANCIA_FIN_DESDE = 'TOLERANCIA_FIN_DESDE',
  TOLERANCIA_FIN_HASTA = 'TOLERANCIA_FIN_HASTA',
}
