...
export const enum ParametroEnum {
  ...
  HHEE_TOLERANCIA_FIN_DESDE = 'HHEE_TOLERANCIA_FIN_DESDE',
  HHEE_TOLERANCIA_FIN_HASTA = 'HHEE_TOLERANCIA_FIN_HASTA',
  ABSN_TOLERANCIA_INICIO_DESDE = 'ABSN_TOLERANCIA_INICIO_DESDE',
  ABSN_TOLERANCIA_INICIO_HASTA = 'ABSN_TOLERANCIA_INICIO_HASTA',
  ABSN_TOLERANCIA_FIN_DESDE = 'ABSN_TOLERANCIA_FIN_DESDE',
  ABSN_TOLERANCIA_FIN_HASTA = 'ABSN_TOLERANCIA_FIN_HASTA',
}
